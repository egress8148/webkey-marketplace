...
export default function HomePageShell() {
  ...
  const { data: quoteDao2Data, isLoading: quoteDao2Loading } = useReadContract({
  ...
  const quoteDao2Amount = quoteDao2Data
        ...
        const orderRes = await fetch('/api/buyer/product-orders', {
          ...
          body: JSON.stringify({
            ...
            delivery_info: (() => {
              const pt = (buyingItem.productType || 'physical') as string
              if (pt === 'physical') {
                return { type: 'physical', address: buyDeliveryAddress, phone: buyDeliveryPhone, note: buyDeliveryNote, email: buyDeliveryEmail }
              }
              if (pt === 'service') {
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="mt-5 grid gap-3 rounded-2xl border border-purple-200/80 bg-white/80 p-4">
                ...
                {/* ✨ Patch v16.0: DAO2 환산 실시간 표시 */}
                <div className="flex items-center justify-between rounded-xl bg-gradient-to-r from-violet-50 to-fuchsia-50 border border-violet-200 px-3 py-2">
                  <span className="text-sm font-black text-violet-700">💰 결제 금액 (DAO2)</span>
                ...
                <div className="text-[11px] text-slate-500 text-right">
                  × {buyQuantity}개 수량 기준 (출시상 실시간 시세)
                </div>
                <div className="flex items-center justify-between text-sm">
