            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                <h1 className="text-4xl font-black tracking-[-0.06em] text-slate-900 md:text-6xl xl:text-7xl">
                  <span className="bg-gradient-to-r from-violet-700 via-fuchsia-600 to-pink-500 bg-clip-text text-transparent">나만의 취향을</span>
                  <br />
                  <span className="bg-gradient-to-r from-sky-600 via-violet-600 to-fuchsia-500 bg-clip-text text-transparent">내 지갑으로 쓰고, 팔다</span>
                </h1>

                <p className="mt-6 max-w-2xl text-sm leading-7 text-slate-700 md:text-base xl:text-lg">
                  의류·신발·액세서리부터 서비스 예약·음식점 주문·디지털 상품까지, 한 곳에서 만날 수 있는 마켓입니다.
                  간편한 결제, 믿을 수 있는 검수, 감각 있는 셀렉션이 모여있어요.
                </p>

                <div className="mt-6 flex flex-wrap gap-3">
                  <span className="rounded-full border border-sky-200 bg-sky-50/90 px-4 py-2 text-xs font-bold text-sky-700 shadow-sm md:text-sm">🔒 안전한 결제</span>
                  <span className="rounded-full border border-fuchsia-200 bg-fuchsia-50/90 px-4 py-2 text-xs font-bold text-fuchsia-700 shadow-sm md:text-sm">🎁 내 포인트로 쓰고 모으고</span>
                  <span className="rounded-full border border-violet-200 bg-violet-50/90 px-4 py-2 text-xs font-bold text-violet-700 shadow-sm md:text-sm">🛡️ 검증된 판매자만</span>
                </div>
              </div>
              ...
              <div className="mt-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                <div className="grid grid-cols-2 gap-3 md:min-w-[340px]">
                  ...
                  <div className="rounded-2xl border border-white/80 bg-white/72 p-4 shadow-lg shadow-fuchsia-100/60 backdrop-blur-xl">
                    ...
                    <div className="mt-1 text-xs text-slate-600">특별 혜택 멤버십</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="mt-6 grid gap-3 sm:grid-cols-2">
                  ...
                  <div className="rounded-2xl border border-white/80 bg-white/78 p-4 shadow-sm">
                    ...
                    <div className="mt-2 text-sm font-bold text-slate-800">내 지갑으로 한 번에 결제</div>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-10 grid gap-6 xl:grid-cols-3">
            <div className="rounded-[30px] border border-white/80 bg-white/78 p-6 shadow-2xl shadow-violet-100/60 backdrop-blur-2xl">
              ...
              <div className="mt-4 space-y-4">
                ...
                <div className="flex gap-3"><span className="flex h-9 w-9 items-center justify-center rounded-full bg-fuchsia-100 font-black text-fuchsia-700">3</span><div><div className="font-bold text-slate-900">간편 결제</div><div className="text-sm text-slate-600">내 지갑에 있는 포인트로 한 번에 결제할 수 있어요.</div></div></div>
              </div>
            </div>
            ...
            {!isAdmin && (
              <div className="space-y-6 xl:col-span-1">
                <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-blue-900/20 to-zinc-900/70 p-8 backdrop-blur">
                  ...
                  <p className="mt-3 text-sm text-slate-700">
                    WebKey 마켓에서 상품을 등록하고 판매하는 전체 순서예요.
                  </p>
